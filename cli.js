...
module.exports = (function () {
  ...
  cli.runTests = function () {
    ...
    var runner = util.promisify(require(path.join(env.dirname, 'test/runner')));
  ...
  cli.generateDocs = function () {
    ...
    if (template.publish && typeof template.publish === 'function') {
      ...
      publishPromise = template.publish(taffy(props.docs), env.opts, resolver.root);
