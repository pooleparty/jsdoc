...
import { cast } from 'jsdoc/util/cast';
import ArgParser from 'jsdoc/opts/argparser';
...
argParser.addOption(
  ...
  'access',
  true,
  'Only display symbols with the given access: "package", public", "protected", "private" or "undefined", or "all" for all access levels. Default: all except "private"',
  true,
);
argParser.addOption(
  'c',
...
argParser.addOption(
  ...
  'match',
  true,
  'When running tests, only use specs whose names contain <value>.',
  true,
);
argParser.addOption(
  '',
  'nocolor',
  false,
  'When running tests, do not use color in console output.',
);
argParser.addOption(
  'p',
  'private',
