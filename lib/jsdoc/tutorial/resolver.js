...
import { strip } from 'jsdoc/util/stripbom';
import tutorial from 'jsdoc/tutorial';
 ...
 */
export const root = new tutorial.RootTutorial();
 ...
 */
export function addTutorial(current) {
  ...
  files.forEach((file) => {
    ...
    if (match) {
      ...
      switch (match[2].toLowerCase()) {
        ...
        // configuration file
        case 'json':
          var meta = JSON.parse(strip(content));
