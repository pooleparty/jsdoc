...
export class Template {
   ...
   */
  load = file => _.template(fs.readFileSync(file, 'utf8'), null, this.settings);
   ...
   *
   * @param {string} file - Template filename.
   * @param {object} data - Template variables (doesn't have to be object,
   * but passing variables dictionary is best way and most common use).
