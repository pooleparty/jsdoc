...
import env from './env';
import { parse } from './tag/type';
import logger from './util/logger';
import defaultDictionary from './tag/dictionary';
import { validate } from './tag/validator';
...
function parseType(tag, tagDef, meta) {
  try {
    return parse(tag.text, tagDef.canHaveName, tagDef.canHaveType);
  } catch (e) {
    logger.error(
...
/**
    ...
    @param {object=} meta
 */
export function Tag(tagTitle, tagBody, meta) {
  var tagDef;
  var trimOpts;
