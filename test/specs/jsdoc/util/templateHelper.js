...
describe('jsdoc/util/templateHelper', () => {
  ...
  describe('linkto', () => {
    ...
    it('works correctly with type unions that are not enclosed in parentheses', () => {
      ...
      expect(link).toBe('(<a href="test.html">linktoTest</a>|' + '<a href="fakeclass.html">LinktoFakeClass</a>)');
    });
  ...
  describe('getAncestorLinks', () => {
    // make a hierarchy.
    var lackeys = new doclet.Doclet(
      '/** @member lackeys\n@memberof module:mafia/gangs.Sharks~Henchman\n@instance*/',
      {},
    );
    var henchman = new doclet.Doclet(
